 ...
 */
@WebServlet(name = "ActualizaAdmin", urlPatterns = {"/ActualizaAdmin"})
public class ActualizaAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActualizaAdmin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActualizaAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
	...
	p.write(ejb.actualizaAdmin(adminid,nombreadmin,apellidoadmin,passwordadmin));
    }
