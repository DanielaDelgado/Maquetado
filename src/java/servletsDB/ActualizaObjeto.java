 ...
 */
@WebServlet(name = "ActualizaObjeto", urlPatterns = {"/ActualizaObjeto"})
public class ActualizaObjeto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActualizaObjeto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActualizaObjeto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
	...
	p.write(ejb.actualizaObjeto(objid,nombreobj,imagenobj,descripcionobj));
    }
