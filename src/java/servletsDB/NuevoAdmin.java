 ...
 */
@WebServlet(name = "NuevoAdmin", urlPatterns = {"/NuevoAdmin"})
public class NuevoAdmin extends HttpServlet {
 @EJB private
            EJBOperaciones ejb;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevoAdmin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevoAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       p.write(ejb.nuevoAdmin(nombreadmin,apellidoadmin,passwordadmin,adminid));
    }
