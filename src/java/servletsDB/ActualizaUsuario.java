...
public class ActualizaUsuario extends HttpServlet {
	...
	String nombreusuario=request.getParameter("nombreusuario");
        ...
        String regionusuario=request.getParameter("regionusuario");
        String contactousuario=request.getParameter("contactousuario");
        
        
	p.write(ejb.actualizaUsuario(usuarioid,nombreusuario,apellidousuario,passwordusuario,regionusuario,contactousuario));
    }
